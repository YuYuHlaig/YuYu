...
<body>
	...
	<div class="container">
   <h2>Delete Customers Listing</h2><br>

   <button type="button" class="btn btn-info"><a href="entry.php">Add New person</a></button>
  <button type="button" class="btn btn-info"><a href="maintable.php">List View</a></button>
...
$query = mysql_query("select * from tempDelete", $con);
